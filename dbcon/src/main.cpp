//////////////////////////////////////////////////////////
// ltcube - main.cpp 
// Calculates exposure of sky points to AMS for a
// specified zenith angle range 
//
// Modified by F.Pilo
// Modified and maintained by I.Sevilla
// Original code by G.Tosti 
//
////////////////////////////////////////////////////// 
...
#include <fstream> 
#include <cstdlib>
//#include <cTPalimits> //for INT_MAX
#include <map>
...
int GetUserOpt(int argc, char* argv[]){
  ...
  opt->addUsage( "Usage: ltcube.exe [options] [arguments]" );
  opt->addUsage( "" );
  ...
  if( ! opt->hasOptions()) {                  // print usage if no options 
    cout<<"[ltcube.exe - WARNING] No options/arguments specified. Using default settings. Type 'ltcube --help' for usage."<<endl;
    delete opt;
    return OK_STAT;
  }
