...
// telescope settings
Float_t angle = -98.644;//deg
Float_t distance=1467;//627;//96;//1182; (bolo 96)
...
void doCoincSAVO_01_03(const char *fileIn="coincSAVO_0103.root"){
  ...
  TFile *fo = new TFile("outputSAVO-01-03.root","RECREATE");
  h->Write();
  hDeltaTheta->Write();
  hDeltaPhi->Write();
  hThetaRel->Write();
