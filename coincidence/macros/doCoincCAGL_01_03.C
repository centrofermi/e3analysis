...
// telescope settings
Float_t angle = 174.64; //deg
Float_t distance=2350;
...
void doCoincCAGL_01_03(const char *fileIn="coincCAGL_0103.root"){
  ...
  TFile *fo = new TFile("outputCAGL-01-03.root","RECREATE");
  h->Write();
  hDeltaTheta->Write();
  hDeltaPhi->Write();
  hThetaRel->Write();
