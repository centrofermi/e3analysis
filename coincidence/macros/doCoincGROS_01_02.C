...
Int_t monthRange[2] = {5,12};
Int_t dayRange[2] = {15,31};
...
// telescope settings
Float_t angle = 165.880091541572369;//deg
Float_t distance=417.969146728515625;//627;//96;//1182; (bolo 96)
...
Float_t deltaphicorr = 0;
Float_t deltaphischoolcorr = 0;
Float_t phi1Corr = 0; // in degrees
Float_t phi2Corr = 0; // in degrees

void doCoincGROS_01_02(const char *fileIn="coincGROS_0102.root"){
