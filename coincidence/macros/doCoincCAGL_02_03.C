...
// telescope settings
Float_t angle = -173.55; //deg
Float_t distance=2517;
...
void doCoincCAGL_02_03(const char *fileIn="coincCAGL_0203.root"){
  ...
  TFile *fo = new TFile("outputCAGL-02-03.root","RECREATE");
  h->Write();
  hDeltaTheta->Write();
  hDeltaPhi->Write();
  hThetaRel->Write();
