doplot(){
  ...
  Float_t errdist[n];
  Float_t rates[n] = {2131,133,80.5,23.9,13.2,22,7.9,6.2};
  Float_t errrates[n] = {6,2.5,1.3,3.7,0.6,2,1.3,1.1};
  ...
  Float_t y[] = {2131,120.5,58.8,20,11.8,17.6,7,5.2};
  Float_t ey[] = {6,1.3,1.2,3.7,0.6,1.6,1.2,0.6};
