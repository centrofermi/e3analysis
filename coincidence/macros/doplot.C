{
  ...
  Float_t errdist[n];
  Float_t rates[n] = {2900,118.5,135,80.5,15.5,18.4,22,7.5,6.2};
  Float_t errrates[n] = {10,1.4,2,1.3,1.2,1.9,2,1.3,1.1};
  ...
  g->SetTitle("Rate not corrected for efficiency (20% syst);distance (m);rate (m^{4} sr)^{-1}");
}
