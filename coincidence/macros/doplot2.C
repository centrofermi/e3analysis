doplot2(){
  ...
  Float_t errdist[n];
  Float_t rates[n] = {3079,160,135,80.5,15.5,17.7,22,7.9,6.2};
  Float_t errrates[n] = {6.3,3.7,2.1,3,2.5,2.6,2,1.3,1.1};
  ...
  Float_t y[] = {3904,133.5,80.5,23.9,13.2,17.6,7,5.2};
  Float_t ey[] = {54,2.5,1.3,2.7,0.6,1.6,1.2,0.6};
