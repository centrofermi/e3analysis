...
Float_t timeCutOn12 = 1000;

// telescope settings (Bologna setting as example)
Float_t angle12 = 1.26037669181823730;
Float_t distance12 = 527;
Float_t angle13 = 3.04800844192504883;
Float_t distance13 = 2350;
...
void doCoinc3(const char *fileIn="coincCAGL-01_CAGL-02_CAGL-03.root"){
